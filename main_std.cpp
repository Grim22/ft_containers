...
int main()
{
    ...
    // lst.sort();
    // for (std::list<int><int>::iterator it = lst.begin(); it != lst.end(); it++)
    // {
    //     std::cout << *it << std::endl;
    // }
    ...
    // lst.push_back(4);
    // lst.push_back(5);
    // std::list<int><int>::iterator it3 = lst.begin();
    // it3++;
    // std::list<int><int> lst2(it3, ++it3);
    // for (std::list<int><int>::iterator it = lst2.begin(); it != lst2.end(); it++)
    // {
    //     std::cout << *it << std::endl;
    // }
    ...
    // std::list<int><int>::iterator it = lst.begin();
    // // for (std::list<int><int>::iterator it = lst.begin(); it != lst.end(); it++)
    // // {
    // //     std::cout << *it << std::endl;
    // // }
